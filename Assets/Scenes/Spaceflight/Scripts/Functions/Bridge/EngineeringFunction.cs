...
public class EngineeringFunction : ButtonFunction
{
	private readonly ButtonFunction[] m_buttonFunctions = { new DamageFunction(), new RepairFunction(), new BridgeFunction() };
