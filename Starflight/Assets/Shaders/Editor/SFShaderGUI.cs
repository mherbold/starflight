...
class SFShaderGUI : ShaderGUI
{
	private static class Styles
	{
		...
		public static readonly GUIContent emissiveText = EditorGUIUtility.TrTextContent( "Emissive", "RGB=Color" );
		public static readonly GUIContent reflectionText = EditorGUIUtility.TrTextContent( "Reflection", "RGB=Color" );
	...
	MaterialProperty m_reflectionColor = null;
	...
	public override void OnGUI( MaterialEditor materialEditor, MaterialProperty[] materialPropertyList )
	{
		...
		// reflection options
		if ( m_reflectionMap != null && m_reflectionColor != null )
		{
			GUILayout.Label( Styles.reflectionText, EditorStyles.boldLabel );

			m_materialEditor.TexturePropertySingleLine( Styles.reflectionText, m_reflectionMap, m_reflectionColor );

			if ( m_reflectionMap.textureValue != null )
			{
				m_materialEditor.TextureScaleOffsetProperty( m_reflectionMap );
			}
		}
	...
	void FindProperties( MaterialProperty[] materialPropertyList )
	{
		...
		m_reflectionColor = FindProperty( "SF_ReflectionColor", materialPropertyList, false );
	...
	void MaterialChanged( Material material )
	{
		...
		bool reflectionMapOn = HasTextureMap( material, "SF_ReflectionMap" );
		...
		SetKeyword( material, "SF_REFLECTIONMAP_ON", reflectionMapOn );
