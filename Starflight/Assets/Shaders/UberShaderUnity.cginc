...
#define ALBEDOOCCLUSION_ON				1
#define NORMALMAP_ON					1
#define NORMALMAP_ISCOMPRESSED			1
#define ORTHONORMALIZE_ON				1
#define EMISSIVEMAP_ON					1
#define WATERMAP_ON						1
#define WATERMAP_ISCOMPRESSED			1
#define WATERMASKMAP_ON					1
//#define LIGHTOVERRIDE_ON				1
#define SHADOWCASTER_ON					1
