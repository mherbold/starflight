...
Shader "Starflight/Water"
{
	Properties
	{
		...
		SF_WaterMap( "Water Map", 2D ) = "bump" {}
		SF_WaterScale( "Water Scale", Vector ) = ( 1, 1, 1, 1 )
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
				...
				#pragma shader_feature SF_WATERMAP_ON
				#pragma shader_feature SF_WATERMAP_ISCOMPRESSED
